...
export class FeedInputComponent {
  ...
  supportedTypes = "image/png,image/jpeg,image/gif,image/jpg,image/bmp,video/mpeg,video/mp4,video/wmv,video/flv,video/avi,video/wav,audio/mpeg,audio/x-wav,image/webp,image/mp3,image/ogg,image/wav";
  ...
  */
  ...
  fireMessageSent() {
    ...
    let payload: MessageSentEventPayload = {
